                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                      <a href="bookDetails.php?id=<?= $book['book_id'] ?>" class="btn btn-sm btn-outline-primary">View Details</a>
                                        <a href="book.php?id=<?= $book['book_id'] ?>" class="btn btn-sm btn-primary">Add to Cart</a>
                                        <a href="book.php?id=<?= $book['book_id'] ?>" class="btn btn-sm btn-outline-danger"><i class="fa-solid fa-heart"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
